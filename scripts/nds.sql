...
CREATE TABLE [dbo].[airline] (
    ...
    airline_code VARCHAR(10) NOT NULL UNIQUE, -- Maps to IATA_CODE
    airline_name VARCHAR(255) NOT NULL,       -- Maps to Airline
...
CREATE TABLE [dbo].[airport] (
    ...
    airport_code VARCHAR(10) NOT NULL UNIQUE, -- Maps to IATA_CODE
    airport_name VARCHAR(255) NOT NULL,       -- Maps to AIRPORT
    city VARCHAR(100),
    state VARCHAR(50),
    country VARCHAR(100),
...
CREATE TABLE [dbo].[flight] (
    ...
    scheduled_departure VARCHAR(10), -- Matches Stage CHAR(10)
